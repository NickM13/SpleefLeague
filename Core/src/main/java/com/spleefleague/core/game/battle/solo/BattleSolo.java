 ...
 * @since 4/24/2020
 */
public abstract class BattleSolo extends Battle {
    
    public BattleSolo(CorePlugin<?> plugin, List<CorePlayer> players, Arena arena, Class<? extends BattlePlayer> battlePlayerClass) {
