 ...
 * @since 4/24/2020
 */
public abstract class BonanzaBattle<A extends Arena, BP extends BattlePlayer> extends Battle<A, BP> {
    
    public BonanzaBattle(CorePlugin<?> plugin, List<CorePlayer> players, A arena, Class<BP> battlePlayerClass) {
