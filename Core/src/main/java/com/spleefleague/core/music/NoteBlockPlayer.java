                ...
                if (layer != null) {
                    ...
                    if (note != null) {
                        ...
                        switch (note.instrument) {
                            case 0:
                                instrument = "minecraft:block.note_block.harp";
                                break;
                            case 1:
                                instrument = "minecraft:block.note_block.bass";
                                break;
                            case 2:
                                instrument = "minecraft:block.note_block.bassdrum";
                                break;
                            case 3:
                                instrument = "minecraft:block.note_block.snare";
                                break;
                            case 4:
                                instrument = "minecraft:block.note_block.hat";
                                break;
                            case 5:
                                instrument = "minecraft:block.note_block.guitar";
                                break;
                            case 6:
                                instrument = "minecraft:block.note_block.flute";
                                break;
                            case 7:
                                instrument = "minecraft:block.note_block.bell";
                                break;
                            case 8:
                                instrument = "minecraft:block.note_block.chime";
                                break;
                            case 9:
                                instrument = "minecraft:block.note_block.xylophone";
                                break;
                            case 10:
                                instrument = "minecraft:block.note_block.iron_xylophone";
                                break;
                            case 11:
                                instrument = "minecraft:block.note_block.cow_bell";
                                break;
                            case 12:
                                instrument = "minecraft:block.note_block.didgeridoo";
                                break;
                            case 13:
                                instrument = "minecraft:block.note_block.bit";
                                break;
                            case 14:
                                instrument = "minecraft:block.note_block.banjo";
                                break;
                            case 15:
                            default:
