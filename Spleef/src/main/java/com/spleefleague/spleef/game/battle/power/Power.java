...
import com.spleefleague.spleef.game.battle.power.effect.Effect;
import com.spleefleague.spleef.game.battle.power.effect.EffectBuff;
import com.spleefleague.spleef.game.battle.power.effect.EffectHeatBolts;
import com.spleefleague.spleef.game.battle.power.effect.EffectRollerSpades;
...
public class Power extends DBEntity {
    ...
    public void updateEffects(SpleefPlayer sp, PowerSpleefBattle sb) {
        for (Effect effect : effects) {
